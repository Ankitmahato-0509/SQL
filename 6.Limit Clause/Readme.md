...
This project demonstrates **basic SQL operations** using a `Movies` table. It covers:
...
- `TOP` and `OFFSET…FETCH` (SQL Server)
...
2. Paste it into your preferred SQL editor:
   - MySQL
   - PostgreSQL
   - SQLite
   - Any other SQL database system
